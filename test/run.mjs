...
// real ~/.marshal/ state, mirroring CI exactly. Set MARSHAL_TEST_REAL_HOME=1 to opt out.
//
...
const sandboxHome = process.env.MARSHAL_TEST_REAL_HOME
  ? null
  : mkdtempSync(join(tmpdir(), "marshal-test-home-"));
